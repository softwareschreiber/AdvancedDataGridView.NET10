...
namespace Zuby.ADGV
{
	partial class MenuStrip
	{
		...
		private void InitializeComponent()
		{
			...
			this.customSearchTextBox = new System.Windows.Forms.ToolStripTextBox();
			this.SuspendLayout();
			_menueWidth                       = LogicalToDeviceUnits(287);
			_itemHeight                       = LogicalToDeviceUnits(22);
			_separatorHeight                  = LogicalToDeviceUnits(6);
			_ButtonHeight                     = LogicalToDeviceUnits(23);
			_ButtonWidth                      = LogicalToDeviceUnits(75);
			_ButtonHostHeight                 = _ButtonHeight + 4;
			_resizeBoxHeight                  = LogicalToDeviceUnits(10);
			_checkFilterListControlHostHeight = LogicalToDeviceUnits(120);
			_checkFilterListControlHostWidth  = LogicalToDeviceUnits(287 - 35);
			_customFilterWidth                = LogicalToDeviceUnits(152);
			_btnOkLocation                    = LogicalToDeviceUnits(164);
			_btnCancelLocation                = LogicalToDeviceUnits(79);
			_resizeBoxControlHostMargin       = LogicalToDeviceUnits(45);
			_achtPixel                        = LogicalToDeviceUnits(8);
			_vierPixel                        = LogicalToDeviceUnits(4);
			_menueHeight                      = 5 * _itemHeight + 2 * _separatorHeight + 2* _ButtonHostHeight + _resizeBoxHeight + 
				_checkFilterListControlHostHeight;
			//
			// MenuStrip
			//
			...
			this.Size       = new System.Drawing.Size(_menueWidth, _menueHeight);
			...
			this.sortASCMenuItem.Size         = new System.Drawing.Size(_menueWidth - 1, _itemHeight);
			...
			this.sortDESCMenuItem.Size         = new System.Drawing.Size(_menueWidth - 1, _itemHeight);
			...
			this.cancelSortMenuItem.Size        = new System.Drawing.Size(_menueWidth - 1, _itemHeight);
			...
			this.customSearchTextBox.AcceptsReturn      = true;
			this.customSearchTextBox.AcceptsTab         = true;
			this.customSearchTextBox.AutoCompleteMode   = System.Windows.Forms.AutoCompleteMode.SuggestAppend;
			this.customSearchTextBox.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.CustomSource;
			this.customSearchTextBox.BorderStyle        = System.Windows.Forms.BorderStyle.FixedSingle;
			this.customSearchTextBox.HideSelection      = false;
			this.customSearchTextBox.MaxLength          = 32000;
			this.customSearchTextBox.Name               = "customSearchTextBox";
			this.customSearchTextBox.ShortcutsEnabled   = false;
			this.customSearchTextBox.Size               = new System.Drawing.Size(_menueWidth - 1, _itemHeight);
			this.customSearchTextBox.Text               = "";
			this.customSearchTextBox.TextBoxTextAlign   = System.Windows.Forms.HorizontalAlignment.Left;
			this.customSearchTextBox.Margin             = new System.Windows.Forms.Padding(4, 0, 0, 0);
			this.customSearchTextBox.DisplayStyle       = System.Windows.Forms.ToolStripItemDisplayStyle.ImageAndText;
			System.Drawing.Bitmap ButtonSearch          = global::Zuby.Properties.Resources.SearchToolBar_ButtonSearch;
			ScaleBitmapLogicalToDevice(ref ButtonSearch);
			this.customSearchTextBox.Image = ButtonSearch;
			this.customSearchTextBox.ImageScaling = System.Windows.Forms.ToolStripItemImageScaling.SizeToFit;
			this.customSearchTextBox.ImageTransparentColor = System.Drawing.Color.Magenta;

			//
			// toolStripSeparator1MenuItem
			//
			this.toolStripSeparator1MenuItem.Name = "toolStripSeparator1MenuItem";
			this.toolStripSeparator1MenuItem.Size = new System.Drawing.Size(_menueWidth - 4,_separatorHeight);
			//
			// cancelFilterMenuItem
			//
			...
			this.cancelFilterMenuItem.Size        = new System.Drawing.Size(_menueWidth - 1, _itemHeight);
			...
			this.toolStripSeparator2MenuItem.Size = new System.Drawing.Size(_menueWidth - 4, _separatorHeight);
			...
			this.customFilterMenuItem.Size   = new System.Drawing.Size(_customFilterWidth, _itemHeight);
			...
			this.customFilterLastFilter1MenuItem.Size            = new System.Drawing.Size(_customFilterWidth, _itemHeight);
			...
			this.customFilterLastFilter2MenuItem.Size         = new System.Drawing.Size(_customFilterWidth, _itemHeight);
			...
			this.customFilterLastFilter3MenuItem.Size         = new System.Drawing.Size(_customFilterWidth, _itemHeight);
			...
			this.customFilterLastFilter4MenuItem.Size         = new System.Drawing.Size(_customFilterWidth, _itemHeight);
			...
			this.customFilterLastFilter5MenuItem.Size         = new System.Drawing.Size(_customFilterWidth, _itemHeight);
			...
			this.customFilterLastFiltersListMenuItem.Size         = new System.Drawing.Size(_menueWidth - 1, _itemHeight);
			...
			this.toolStripSeparator3MenuItem.Size = new System.Drawing.Size(_menueWidth - 4, _separatorHeight);
			//
			// resizeBoxControlHost
			//
			...
			this.resizeBoxControlHost.Margin         = new System.Windows.Forms.Padding(_menueWidth - _resizeBoxControlHostMargin, 0, 0, 0);
			this.resizeBoxControlHost.Size           = new System.Drawing.Size(_resizeBoxHeight, _resizeBoxHeight);
			...
			this.checkFilterListControlHost.Size     = new System.Drawing.Size(_checkFilterListControlHostWidth, _checkFilterListControlHostHeight);
			...
			this.checkFilterListButtonsControlHost.Size     = new System.Drawing.Size(_checkFilterListControlHostWidth, _ButtonHostHeight);
			...
			this.checkList.Bounds                = new System.Drawing.Rectangle(_vierPixel, _vierPixel, this.checkFilterListPanel.Width - _achtPixel, this.checkFilterListPanel.Height - _achtPixel);
			...
			this.button_ok.Size                    = new System.Drawing.Size(_ButtonWidth, _ButtonHeight);
			this.button_ok.Text                    = _textStrings["BUTTONOK"].ToString();
			this.button_ok.Click                  += new System.EventHandler(button_ok_Click);
			this.button_ok.Location                = new System.Drawing.Point(this.checkFilterListButtonsPanel.Width - _btnOkLocation, 0);
			//
			// button_cancel
			//
			...
			this.button_cancel.Size                    = new System.Drawing.Size(_ButtonWidth, _ButtonHeight);
			...
			this.button_cancel.Location                = new System.Drawing.Point(this.checkFilterListButtonsPanel.Width - _btnCancelLocation, 0);
			//
		...
		private System.Windows.Forms.ToolStripTextBox customSearchTextBox;
		...
		private int _menueWidth, _menueHeight, _itemHeight, _separatorHeight, _ButtonWidth, _ButtonHeight, _ButtonHostHeight, _resizeBoxHeight, 
			_checkFilterListControlHostHeight, _checkFilterListControlHostWidth, _customFilterWidth, _btnOkLocation, _btnCancelLocation,
			_resizeBoxControlHostMargin, _achtPixel, _vierPixel;
	}
}
